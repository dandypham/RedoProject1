...
public class DBUtils {
	...
	public static List<Product> queryPendingProduct(Connection conn) throws SQLException {
		String sql = "Select a.User_Id, a.Code, a.Name, a.Price, a.Approval, a.Managername, a.Request_Id from Product_DP a where a.Approval = 'PENDING'  ";
	...
	public static List<Product> queryResolvedProduct(Connection conn) throws SQLException {
		String sql = "Select a.User_Id, a.Code, a.Name, a.Price, a.Approval, a.Managername, a.Request_Id from Product_DP a where a.Approval in ('APPROVE', 'DECLINE') ";
	 ...
	 public static List<Product> querySpecificProduct(Connection conn, Integer requestidpass) throws SQLException {
		 String sql = "Select a.User_Id,a.Code, a.Name, a.Price, a.Approval, a.Managername, a.Request_Id from Product_DP a where a.Request_Id=?"; 
		 	System.out.println("Get to queryEmployeeProduct");
			PreparedStatement pstm = conn.prepareStatement(sql);
			pstm.setInt(1, requestidpass); 
			ResultSet rs = pstm.executeQuery();
			List<Product> list = new ArrayList<Product>();
			while (rs.next()) {
