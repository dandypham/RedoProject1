    ...
    <h3>Request List</h3>
      ...
      <div class="d-flex justify-content-center h-100">
       ...
       <c:forEach items="${productList}" var="product" >
         ...
         <a href="pending" class="btn btn-warning" role="button">Pending Request</a> 
         <a href="resolved" class="btn btn-warning" role="button">Resolved Request</a>
         <a href="viewSpecific" class="btn btn-warning" role="button">View Specific</a>
